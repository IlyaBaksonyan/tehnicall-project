<template>
	...
	>
		...
		/>
		<path
			style="fill: none; stroke: #222222; stroke-width: 1"
		...
		/>
		<path
			style="fill: #444; stroke: #333; stroke-width: 1.5"
		...
		/>
		<path
			style="fill: none; stroke: #222; stroke-width: 1.5"
			d="M 44.9,46.4 C 55.2,51.5 62,61.8 65.4,72 c 1.2,5.7 2.3,17.1 -8,21.6 C 48.3,98.2 39.2,99.3 27.9,91.4 18.8,83.4 9.25,72 5.85,67.5 3.57,64 2.55,61.8 3,57.2 3,53.8 4.82,52.7 11.4,49.8 26.7,42.9 31.3,44 37,44 c 4.5,0 7.9,2.4 7.9,2.4 z"
		/>
		<path
			style="fill: #ccc"
			d="m 25.6,69.7 c 7.9,16 26.2,23.9 38.7,5.7 C 54,97 30.1,90.2 25.6,69.7 z"
		/>
	</svg>
</template>
